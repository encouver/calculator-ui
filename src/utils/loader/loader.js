...
function getDelayedFallback(Fallback, delay) {
    return function DelayedFallback(props) {
        ...
        return isDelayPassed ? _jsx(Fallback, { ...props }) : null;
    };
}
/* ================================================================================== */
...
const getLazyComponent = (loadComponent, loaderOptions) => lazy(() => {
...
function asyncComponentLoader(loadComponent, additionalProps, loaderOptions, FallbackWaiting) {
    ...
    return function AsyncComponent(props) {
        return (_jsx(Suspense, { fallback: _jsx(Fallback, {}), children: _jsx(LazyComponent, { ...additionalProps, ...props }) }));
    };
}
